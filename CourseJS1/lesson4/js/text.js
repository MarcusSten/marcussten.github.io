var works = {
    ...
    d00: 'Что бы вы не выбрали, будьте уверены, что ваши дальнейшие решения не имеют никакого значения. Выбор всегда в подсознании. На деле же вы выполняете действие и получаете результат. Выбора нет!\n',
    d0: 2, // кол-во ответов
    d1: '1 - Красная таблетка\n',
    d2: '2 - Синяя таблетка\n',
};
